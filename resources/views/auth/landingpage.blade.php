        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text=base font-semibold text-primary md:text-xl">Halo Semua 👋, saya <span class="block font-bold text-dark text-4xl mt-1 lg:text-5xl">Maritza Angel</span></h1>
                    <h2 class="font-medium text-slate-500 text-lg mb-5 lg:text-2xl">Lecturer & <span class="text-dark">Content Creator</span></h2>
                    <p class="font-medium text-slate-400 mb-10 leading-relaxed">Belajar web programming itu mudah dan menyenangkan bukan! <span class= "text-dark font-bold">bukan</span></p>

                    <a href="#" class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Mari Berteman!</a>
                </div>
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:mt-9 lg:right-0">
                        <img src="images/fotoangel.png" alt="Maritza Angel" class="max-w-full mx-auto"/>
                        <span class="absolute -bottom-5 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                            <svg width="400" height="400" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#14b8a6" d="M36.3,-52.7C47.1,-42.2,55.7,-31.6,61,-19C66.2,-6.4,67.9,8.1,62.9,19.5C57.9,30.8,46.1,39,34.5,44.4C22.9,49.7,11.4,52.3,-3.2,56.7C-17.9,61.1,-35.7,67.4,-48.3,62.4C-60.9,57.4,-68.3,41,-68.1,25.8C-67.9,10.7,-60.1,-3.1,-56.3,-19.4C-52.5,-35.6,-52.7,-54.2,-44,-65.3C-35.2,-76.5,-17.6,-80.2,-2.4,-76.9C12.8,-73.6,25.6,-63.2,36.3,-52.7Z" transform="translate(100 100) scale(1.1)" />
                              </svg>
                        </span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-dark text-3xl mb-5 max-w-md dark:text-white">Saya Mahasiswi Software Engineering, Universitas Gadjah Mada</h2>
                ...
                <div class="w-full px-4 lg:w-1/2 mt-7">
                    <h3 class="font-bold text-dark text-3xl mb-4 max-w-md dark:text-white">Mari Berteman</h3>
